# 🛑プロジェクトは続行中止となりました
aiと共同で作ったこのプロジェクトですが、荒らし目的での開発もあったので自責の念を込めて中止とさせていただきました。
ご迷惑をおかけしたすべての関係者の皆様、本当に申し訳ございませんでした。
アーカイブとして残しますが、使う際は完全に自己責任でお願いします。それによって生じた問題について自分は責任を放棄します。
# discord荒らしの皆さまへ
別に使ってもいいですが、絶対に自己責任です。責任は取りません。
何度も言いますが、自己責任です。そもそもバグ多いです。というか荒らさないでください

以下のREADMEはgeminiによって作成されました
